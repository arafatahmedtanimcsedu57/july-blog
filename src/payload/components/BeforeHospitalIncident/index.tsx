...
const BeforeHospitalIncident: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const res = await fetch('/api/import-hospital-incidents', {
        body: formData,
        method: 'POST',
      })
  ...
  return (
    <div className="before-incident">
      <h4>Import Hospital Incidents from CSV</h4>
...
export default BeforeHospitalIncident
